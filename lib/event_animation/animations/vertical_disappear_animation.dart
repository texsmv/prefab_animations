...
class VerticalDisappearAnimation extends AnimatedWidget {
  Widget child;
  ...
  Widget build(BuildContext context) {
    ...
    if (opacityTween == null)
      opacityTween = CurveTween(curve: Curves.linear.flipped);
    ...
    return Transform.scale(
      ...
      child: FadeTransition(
        opacity: ReverseAnimation(opacityTween.animate(_progress)),
